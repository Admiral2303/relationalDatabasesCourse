...
let AdditionalFunctionsForDB = require('../../models/functionToDB')
let { drivingSchoolModel,groupsModel,instructorModel,studentModel, sequelize} = require('../../seq');
let groups = new Groups(groupsModel);
let instructors = new Instructors(instructorModel);
let driving_schools = new Drschools(drivingSchoolModel);
let students = new Students(studentModel, sequelize);
let f = new AdditionalFunctionsForDB(sequelize);
// students.findPhrase('dsfdsf').then(data => console.log(data))
// console.log(f.)
// f.down().then(() => {
// f.up().then(() => {
//     f.findActorsByFilmAndSex('dsfdsfdsf', 'ds')
//         .then(data => console.log(data))
// })
// })
// driving_schools.getDrivingSchoolById(1).then(data => console.log(data))
// groups.insertGroup({
//   name: '3',
//   max_count: 20,
//   ins_id: 1
...
//   surname: '10',
//   date: 2017,
//   description: "dsfdfds dsfdsf dddd qwerty", 
//   sex: 'male',
